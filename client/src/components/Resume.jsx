      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 border-l-2 border-indigo-500/30 pl-6 ml-4">
              {education.map((item, idx) => (
                <div
                  key={idx}
                  className={`p-6 rounded-2xl border transition duration-300 hover:scale-[1.02] relative ${
                    isDark
                ...
                >
                  {/* Timeline node */}
                  <div className="absolute -left-[31px] top-6 w-3.5 h-3.5 rounded-full bg-indigo-500 ring-4 ring-[#030712]" />
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 border-l-2 border-cyan-500/30 pl-6 ml-4">
              {experience.map((item, idx) => (
                ...
                >
                  {/* Timeline node */}
                  <div className="absolute -left-[31px] top-6 w-3.5 h-3.5 rounded-full bg-cyan-400 ring-4 ring-[#030712]" />

                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 mb-3">
                    <Calendar size={12} /> {item.date}
                  </span>
                  <h4 className="text-lg font-bold">{item.title}</h4>
